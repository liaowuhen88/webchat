<%@ page language="java" import="java.util.*,api.*,net.sf.json.*,api.service.*;" pageEncoding="UTF-8"  contentType="text/html;charset=utf-8"%>
<%
...
function ajax(page){
	...
	$.ajax({ 
        type: "post", 
         url: "CommonServlet",
         data:"method=CashList&page="+pageCount+"&oauth_token="+oauth_token+"&uid="+uid,
         dataType: "", 
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
  <tr>
      <td id="brt"  class="chongzhi_tit_r" width="25%" ><a href="http://liaowuhen.duapp.com/xinlongct/txjl.jsp">提现记录</a></td>
